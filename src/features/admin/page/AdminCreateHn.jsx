    ...
    <div className="flex justify-center px-40 py-16 gap-10 min-h-[80vh] ">
      ...
      <div className="flex flex-1 flex-col border-[1px] border-ms-gold min-h-[800px] h-full rounded-[40px] pt-10 pb-20 px-16 gap-4   ">
        <div className="flex items-center justify-center mb-2 text-center px-8 text-ms-gray">
          <h1 className="font-th text-4xl mb-8 font-semibold text-ms-green ">
            ลงทะเบียนข้อมูลคนไข้
          </h1>
        </div>
        ...
        <div className="grid grid-cols-3 gap-14 font-th">
          <div className="flex  justify-center flex-col">
            ...
            <input
              ...
              className=" h-12 w-72 rounded-full mt-2  border-[1.5px] border-ms-gold px-4  focus:outline-ms-green"
            />
          </div>
          ...
          <div className="flex  justify-center flex-col">
            ...
            <select
              ...
              name="gender"
              id="gender"
              className="h-12 w-72 outline-ms-green rounded-3xl border-[1.5px] px-4 border-ms-gold  "
            >
          ...
          <div className="flex  justify-center flex-col">
            ...
            <textarea
              ...
              name="address"
              onChange={handleChangeInput}
              className=" h-32 w-72 rounded-3xl mt-2  border-[1.5px] border-ms-gold p-4  focus:outline-ms-green"
            />
          </div>
        ...
        <div className="flex justify-end gap-14 px-16 mt-14">
          <button
            ...
            className="font-th w-[210px] h-[60px] bg-ms-green rounded-full text-white text-xl hover:bg-[#257956]"
          >
            {" "}
            สร้าง HN{" "}
          </button>
          <button
            ...
            className="font-th w-[210px] h-[60px]  rounded-full text-ms-gray text-xl border-[1.5px] border-ms-gold bg-white hover:bg-[#89713e] hover:text-white "
          >
            {" "}
            ยกเลิก{" "}
          </button>
