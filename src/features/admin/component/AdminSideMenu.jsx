  ...
  return (
   <>
      ...
      <div className="flex flex-col w-72 min-w-60 border-[1px] border-ms-gold min-h-[800px] h-full rounded-[40px] pt-10 pb-20 pl-6 gap-4 font-semibold text-ms-gray">
        ...
        <div >  <Link to='/admin/appoint'>   <button className={` font-th ${pathname=="/admin/appoint" ? 'text-ms-green hover:no-underline hover:cursor-default ' : 'hover:underline text-ms-gray' }`} > ค้นหาใบนัด  </button> </Link> </div>
